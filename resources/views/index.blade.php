...
<head>
  ...
  <title>AdminLTE 2 | Data Pegawai</title>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a  class="glyphicon glyphicon-edit" href="/pegawai/edit/{{ $p->pegawai_id }}"></a>
                        |
                        <a  class="glyphicon glyphicon-trash" href="/pegawai/delete/{{ $p->pegawai_id }}"></a>
                    </td>
                </tr>
