              ...
              <div class="col-md-3">
                ...
                <div class="box box-primary">
                  <div class="box-body box-profile">
                    ...
                    <h3 class="profile-username text-center">Hafizh Anggit Barnawa</h3>
      
                    <p class="text-muted text-center">Network Engineer</p>
      
                    <ul class="list-group list-group-unbordered">
                      <li class="list-group-item">
                        <b>Followers</b> <a class="pull-right">336</a>
                      </li>
                      <li class="list-group-item">
                        <b>Following</b> <a class="pull-right">716</a>
                      </li>
                      <li class="list-group-item">
                        <b>Friends</b> <a class="pull-right">905</a>
                      </li>
                    </ul>
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body">
                    ...
                    <p class="text-muted">
                      S.Kom. in Informatics Engineering from the University of Ahmad Dahlan
                    </p>
                    ...
                    <p class="text-muted">D.I. Yogyakarta</p>
                    ...
                    <p>
                      <span class="label label-danger">Network Design</span>
                      <span class="label label-success">Coding</span>
                      <span class="label label-info">Crimping</span>
                      <span class="label label-warning">Network Installation & Configuration</span>
